    ...
    for json_file in json_files:
        ...
        if not os.path.exists(climate_spatialmos_file) or not os.path.exists(climate_spatialmos_nwp_file) or not os.path.exists(spatialmos_coef_file):
            ...
            if not os.path.exists(climate_spatialmos_nwp_file):
                logging.error("File %s is missing", climate_spatialmos_nwp_file)
        ...
        spatialmos_run_status = spatial_prediction(alt_file, alt_area_file, climate_spatialmos_file, climate_spatialmos_nwp_file, data_path_spool, gribfiles_data, spatialmos_coef_file, spatialmos_run_status, parser_dict)
        write_spatialmos_run_file(data_path_spool, gribfiles_data["anal_date"], spatialmos_run_status)
