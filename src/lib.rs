...
mod tests {
    ...
    fn test_rs_combine_gribdata() {
        ...
        let combined_ok = vec![
            [45.0, 8.0, 0.24, -0.61, 4.6],
            [45.0, 8.5, 0.27, -0.56, 4.3],
            [45.0, 9.0, 0.32, -0.49, 3.27],
            [45.5, 8.0, 0.19, -0.72, 2.66],
            [45.5, 8.5, 0.18, -0.74, 4.83],
            [45.5, 9.0, 0.14, -0.85, 5.82],
            [46.0, 8.0, 0.87, -0.06, -8.55],
            [46.0, 8.5, 0.18, -0.74, -0.61],
            [46.0, 9.0, 0.15, -0.82, -0.41],
        ];
        assert_eq!(2,3)
    }
}
