...
class TestCombinePredictions(unittest.TestCase):
    ...
    def test_combine_predictions(self):
        ...
        try:
            data = combine_predictions.merge_predictions(
                parser_dict, data_path_spool, ["006", "012", "018"]
            )
            ...
            with open(
                Path("./tests/testdata/test_prediction/20210803_predictions.json"),
                "r",
                encoding="utf-8",
                ...
                self.assertDictEqual(
                    spatialmos_merged_prediction_ok, spatialmos_merged_prediction
                )
        finally:
