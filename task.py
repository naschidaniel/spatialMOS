...
MAIN_NS.add_task(inv_spatialmos.archive_folder__measurements)
MAIN_NS.add_task(inv_spatialmos.archive_folder__suedtirol)
MAIN_NS.add_task(inv_spatialmos.archive_folder__zamg)
MAIN_NS.add_task(inv_spatialmos.combine_gamlss_climatology)
MAIN_NS.add_task(inv_spatialmos.combine_data)
MAIN_NS.add_task(inv_spatialmos.combine_measurements)
